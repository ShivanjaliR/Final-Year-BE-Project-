...
public class VMLogs extends ListActivity
{
    ...
    public void onCreate(Bundle icicle) {
		...
		String[] sSenderIDs = oHTValues.get("SenderAccNo").trim().split(";");
	...
	public static class MyCustomBaseAdapterTrans extends BaseAdapter 
	{
		 ...
		 public View getView(int position, View convertView, ViewGroup parent) {
			  ...
			  holder.txtSender.setText("Sender : " + searchArrayList.get(position).getSenderId());
